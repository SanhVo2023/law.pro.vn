...
export default async function ArticlePage({ params }: { params: Promise<Params> }) {
  ...
  const doc = await getArticleBySlug(slug, locale as Locale)
  if (!doc) notFound()
  return <ArticleDetail doc={doc as never} locale={locale as Locale} hubPathname="/thuc-tien-xet-xu" articlePathname="/thuc-tien-xet-xu/[slug]" />
}
