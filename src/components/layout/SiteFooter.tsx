  ...
  return (
    <footer className="mt-32 bg-[var(--color-parchment)] border-t border-[var(--color-rule)]">
      ...
      <div className="border-t border-[var(--color-rule)]">
        <div className="mx-auto max-w-screen-2xl px-6 lg:px-10 py-6 flex flex-col md:flex-row md:items-center md:justify-between gap-3 text-xs text-[var(--color-ink-muted)] font-[family-name:var(--font-inter)]">
